...
public class CodeGenerator {
     ...
     * 代码生成位置
     */
    public static final String PARENT_NAME = "com.wang";

    /**
     * modular 名字
     */
    public static final String MODULAR_NAME = "generator-code/";
    ...
    public static final String JDBC_MYSQL_URL = "jdbc:mysql://localhost:3306/shop?useUnicode=true&characterEncoding=UTF-8&autoReconnect=true&useSSL=false&zeroDateTimeBehavior=convertToNull&allowMultiQueries=true&serverTimezone=Asia/Shanghai";
            ...
            public void initMap() {
                ...
                fileOutConfigList.add(new FileOutConfig("/templates/mapper.xml.vm") {
                    ...
                    public String outputFile(TableInfo tableInfo) {
                        ...
                        return projectPath + "/generator-code" + "/src/main/resources/mapper/" +
